        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 bg-purple-50 text-purple-600 px-4 py-2 rounded-full">
              ...
              <span className="text-sm">14 Days Free Trial - No Credit Card Required</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-lg max-w-xl">
                Access our vast collection of 50,000+ royalty-free tracks, professionally curated by our music directors. New industry-specific playlists added weekly to enhance your customer experience.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">50,000+ Tracks</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-purple-100 flex items-center justify-center">
                  <svg className="w-3 h-3 text-[#6E59A5]" fill="currentColor" viewBox="0 0 20 20">
