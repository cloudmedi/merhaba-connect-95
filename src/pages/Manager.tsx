    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b">
        ...
        <nav className="flex items-center space-x-6">
          <a href="#" className="text-black hover:text-[#FFD700]">Home</a>
          <a href="#" className="text-black hover:text-[#FFD700]">Campaigns</a>
          <a href="#" className="text-black hover:text-[#FFD700]">Device</a>
          <a href="#" className="text-black hover:text-[#FFD700]">Calendar</a>
          <button className="bg-[#FFD700] text-black px-4 py-2 rounded-full font-medium">
            User Name
          </button>
        </nav>
      </header>
      ...
      {/* Hero Section */}
      <div className="relative bg-[#8B4543] p-8 mx-6 mt-6 rounded-xl overflow-hidden">
            ...
            <Card key={playlist.id} className="bg-white border-none shadow-sm hover:shadow-md transition-shadow overflow-hidden group">
              <div className="relative aspect-square">
                ...
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="w-12 h-12 rounded-full bg-[#FFD700] flex items-center justify-center text-black">
                    ▶
                  </button>
                </div>
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center space-x-4">
            <button className="w-10 h-10 rounded-full bg-[#FFD700] flex items-center justify-center text-black">
              ▶
            </button>
